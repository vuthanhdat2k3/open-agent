...
SYSTEM_AGENT_BLUEPRINTS: dict[str, SystemAgentBlueprint] = {
    ...
    "coder": SystemAgentBlueprint(
        ...
        system_prompt=(
            ...
            "  * Data & Analysis: `pandas`, `numpy`, `scipy`, `tabulate`, `sympy`, `openpyxl`, `xlsxwriter`\n"
            "  * Visualization: `matplotlib`, `seaborn`, `Pillow` (save charts to workspace e.g., `plt.savefig('output.png')`)\n"
            "  * Document & PDF Generation: `fpdf2`, `reportlab`, `pypdf`, `markdown`, `jinja2`, `pandoc`\n"
            ...
            "- For PDF Generation:\n"
            "  * You can use Python with `fpdf2` or `reportlab` to compile `.pdf` files directly in the workspace.\n"
