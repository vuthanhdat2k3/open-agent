...
SYSTEM_AGENT_BLUEPRINTS: dict[str, SystemAgentBlueprint] = {
    ...
    "general": SystemAgentBlueprint(
        ...
        system_prompt=(
            ...
            "  * DO NOT ask the worker subagent to recreate or rewrite the file from scratch.\n"
            "  * State ONLY what is new: mention the exact file name (e.g. `beautiful_3d_house.html`, `main.py`) and the exact requested action (e.g. preview web artifact, run script in sandbox).\n"
