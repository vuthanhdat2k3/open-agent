...
def test_classifier_routes_spam_calendar_and_treats_guard_flags_as_context():
    ...
    assert classify_email(_email(subject="Hello", flags=["prompt_injection"])).label == "normal"
