        ...
        "nodes": [
            {
                ...
                "config": {"cron": "0 7 * * 1-5", "schedule_label": "Weekdays at 07:30"},
            },
            {
                "id": "integration",
                "kind": "integration",
            ...
            },
            {
                ...
                "config": {
                    "policy": "rank_by_urgency",
                    "categories": "high_priority, meetings, reminders",
                },
            },
            {
                "id": "agent",
        ...
        "nodes": [
            {
                ...
                "config": {"cron": "0 * * * *", "schedule_label": "Every hour"},
            },
            {
                "id": "integration",
                "kind": "integration",
            ...
            },
            {
                ...
                "config": {"policy": "filter_client_meetings", "window_hours": 24},
            },
            {
                "id": "agent",
                "kind": "agent",
        ...
        "nodes": [
            {
                ...
                "config": {"cron": "0 9 * * 1-5", "schedule_label": "Daily at 09:00"},
            },
            {
                "id": "integration",
                "kind": "integration",
            ...
            },
            {
                ...
                "config": {"policy": "stale_conversations", "threshold_days": 3},
            },
            {
                "id": "agent",
                "kind": "agent",
    ...
    "new-customer-intelligence": {
        ...
        "nodes": [
            ...
            },
            {
                ...
                "config": {"policy": "classify_lead", "categories": "enterprise, smb, personal"},
            },
            {
                "id": "agent",
                "kind": "agent",
        ...
        "nodes": [
            {
                ...
                "config": {"cron": "30 17 * * 1-5", "schedule_label": "Daily at 17:30"},
            },
            {
                "id": "integration",
                "kind": "integration",
        ...
        "nodes": [
            {
                ...
                "config": {"cron": "0 8 * * 1", "schedule_label": "Mondays at 08:00"},
            },
            {
                "id": "integration",
                "kind": "integration",
    ...
    "gmail_monitor_and_triage": {
        ...
        "nodes": [
            ...
            },
            {
                ...
                "config": {
                    "policy": "intent_classification",
                    "categories": "urgent, sales, support, newsletter",
                },
            },
            {
                "id": "agent",
...
def upgrade() -> None:
    ...
    for key, graph_dict in TEMPLATE_DAGS.items():
        ...
        if dialect == "postgresql":
            conn.execute(
                sa.text(
                    "UPDATE workflows SET graph = CAST(:graph AS json) WHERE (graph->>'template_key') = :key"
                ),
            ...
            try:
                conn.execute(
                    sa.text("UPDATE workflows SET graph = :graph WHERE graph LIKE :like_key"),
                    {"graph": graph_json, "like_key": f'%"{key}"%'},
                )
            except Exception:
                pass
