...
| `feat/rbac-clean-personas-knowledge-base` | `G:\open-agent-worktrees\rbac-clean-personas` | Streamline ultra-clean persona navigation, knowledge base RAG, and session attachment isolation | ox-alpha |
