...
| `feat/tool-live-progress-subagent-stream` | `G:\open-agent-worktrees\tool-live-progress` | Live tool execution progress and subagent SSE streaming (thinking, response, sub-tools) | ox-alpha |
...
> #106 chat-streaming-text-fidelity, #108 chat-scroll-flicker-tool-loading-fix).
