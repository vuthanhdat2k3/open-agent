...
export interface TranslationDictionary {
  ...
  pages: {
    dashboard: {
      ...
      statOrgsTotal: string;
      statOrgsActive: string;
      statPlatformServices: string;
      statPlatformInvocations: string;
      statMembersTotal: string;
      statQuotaUsage: string;
      statWorkflowsTotal: string;
      statMcpConnected: string;
      statKnowledgeDocs: string;
      statEvaluationsPassed: string;
      platformHealthTitle: string;
      platformHealthDesc: string;
      recentOrgsTitle: string;
      recentOrgsDesc: string;
      ...
      btnViewAudit: string;
      btnNewAgent: string;
      btnDesignWorkflow: string;
      btnRunEvaluation: string;
      btnOpenSandbox: string;
      btnEmailGateway: string;
      btnQuotas: string;
