  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="outline" size="sm" className={collapsed ? "h-10 w-10 justify-center p-0" : "w-full justify-between gap-2 px-3"} aria-label={`${tx("Tổ chức đang chọn: ", "Active organization: ")}${currentMembership.org_name || currentMembership.org_id}`}>
