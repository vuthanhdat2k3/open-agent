...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        // Refined, tinted, wide-spreading shadow for elevated cards (no neon glow)
        card: "0 1px 2px hsl(var(--foreground) / 0.04), 0 8px 24px -12px hsl(var(--foreground) / 0.12)",
        // Lighter diffusion for floating/glass surfaces
        diffuse: "0 24px 60px -24px hsl(var(--foreground) / 0.18)",
        // Pressed/inset edge for glassmorphism refraction
      ...
      animation: {
        ...
        "scale-in": "scale-in 0.4s var(--ease-out-expo) both",
